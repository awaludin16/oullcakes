...
// Batasi dan acak jumlah produk lainnya yang ditampilkan menjadi 7
shuffle($produkLainnya);
$produkLainnya = array_slice($produkLainnya, 0, 7);
?>
...
<body>
  ...
  <div class="detail-produk">
    <table cellspacing="0">
      <tr>
        <td rowspan="4">
          <img src="assets/img/menu/<?= $detailProduk['gambar']; ?>" alt="<?= $detailProduk['nama']; ?>">
        </td>
      </tr>
      <tr>
        <td>Nama</td>
        <td><?= $detailProduk['nama']; ?></td>
      </tr>
      <tr>
        <td>Harga</td>
        <td>Rp. <?= $detailProduk['harga']; ?></td>
      </tr>
      <tr>
        <td>Deskripsi</td>
        <td><?= $detailProduk['deskripsi']; ?></td>
      </tr>
    </table>
  </div>
  <!-- Detail Produk -->
  ...
  <div class="produk-lainnya">
    ...
    <div class="produk">
      <?php foreach ($produkLainnya as $produk) : ?>
